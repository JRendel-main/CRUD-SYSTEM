...
<div class="container">
	...
	<span style="font-size:25px; color:#66b3ff"><center><strong>TRANSACTION MANAGEMENT SYSTEM</strong><br><small>For CICT Transactions only!</small></small></center></span>	
		...
		<buttton type='submit' class='btn btn-success pull-right' name='Export' id='Export' onClick='Export()' value='Export to Excel'><span class="glyphicon glyphicon-export"></span> Export to Excel</buttton>
		<div style="height:50px;"></div>
		<form action="index.php" method="POST">
			<input type="text" name="search" placeholder="Search" class="form-control" id='myInput' style='width: 30%;'>
		</form>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				$query=mysqli_query($conn,"select * from `user` ORDER by reciept LIMIT $offset, $total_records_per_page");
